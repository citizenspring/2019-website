...
describe('email', () => {
  ...
  it('cleans the HTML', () => {
    const email = {
      'body-html': '<div dir=ltr></div><div dir=ltr>This is cool!</div><div dir=ltr></div>',
    };
    const html = libemail.getHTML(email);
  ...
  it('markdown quote', () => {
    ...
    const html = libemail.getHTML(email);
    expect(html).toEqual(
      `<blockquote><p>« Le futur est déjà ici. Il est tout simplement pas encore uniformément disponible » - quelqu'un de célèbre.</blockquote>`,
    );
  });
  ...
  it('markdown image', () => {
    const email = {
      'body-html':
        '<div dir="ltr"><div dir="ltr">Here is the poster made by Stien for everyone to see:&nbsp;<div>![](<a href="https://d.pr/free/i/6XpCWL+">https://d.pr/free/i/6XpCWL+</a>)</div></div></div><br><div class="gmail_quote"><div dir="ltr" class="gmail_attr">On Tue, Feb 26, 2019 at 3:00 PM Xavier Damman &lt;<a href="mailto:xdamman@gmail.com">xdamman@gmail.com</a>&gt; wrote:<br></div><blockquote class="gmail_quote" style="margin:0px 0px 0px 0.8ex;border-left-width:1px;border-left-style:solid;border-left-color:rgb(204,204,204);padding-left:1ex"><div><div dir="auto">Not yet :-/&nbsp;</div></div><div dir="auto">It’s on my todo list.</div><div dir="auto"><br></div><div dir="auto">In the meantime feel free to just send it to my email <a href="mailto:email@domain.org" target="_blank">email@domain.org</a></div><div><br><div class="gmail_quote"><div dir="ltr" class="gmail_attr">On Tue, Feb 26, 2019 at 2:57 PM Stien Verbelen &lt;<a href="mailto:design@citizenspring.be" target="_blank">design@citizenspring.be</a>&gt; wrote:<br></div><blockquote class="gmail_quote" style="margin:0px 0px 0px 0.8ex;border-left-width:1px;border-left-style:solid;border-left-color:rgb(204,204,204);padding-left:1ex">\r\n    <u></u>\r\n    \r\n      \r\n        \r\n      \r\n      <div style="margin:0px;padding:0px">\r\n      \r\n      <table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td colspan="5" style="font-family:&quot;Helvetica Neue&quot;;line-height:1.3;padding:10px"><div><div>How do i do that? Can i upload it on the website? 🤔</div></div><table style="margin-top:2rem" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td colspan="6" style="color:rgb(85,85,85);line-height:28px;font-size:14px"><span>Pick a quick reaction (or hit reply)</span></td></tr><tr><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%F0%9F%91%8D" style="font-size:28px;text-decoration:none;margin:13px" target="_blank">👍</a></td><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%F0%9F%91%8E" style="font-size:28px;text-decoration:none;margin:13px" target="_blank">👎</a></td><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%F0%9F%98%84" style="font-size:28px;text-decoration:none;margin:13px" target="_blank">😄</a></td><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%F0%9F%98%95" style="font-size:28px;text-decoration:none;margin:13px" target="_blank">😕</a></td><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%F0%9F%8E%89" style="font-size:28px;text-decoration:none;margin:13px" target="_blank">🎉</a></td><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%E2%9D%A4%EF%B8%8F" style="font-size:28px;text-decoration:none;margin:13px" target="_blank">❤️</a></td></tr></tbody></table></td></tr><tr><td colspan="5" height="30"> </td></tr><tr style="background-color:rgb(249,249,249);color:black;width:100%;font-family:&quot;Helvetica Neue&quot;;font-size:12px;margin-top:3rem;padding:3px;text-decoration:none;height:28px;line-height:28px;background-position:initial initial;background-repeat:initial initial"><td width="5"></td><td width="28" style="background-image:url(&quot;https://citizenspring.be/static/images/opencollectiveicon-48x48@2x.png&quot;);background-size:22px 22px;background-position:50% 50%"></td><td align="left"><a style="text-decoration:none;color:black" href="https://citizenspring.be/design/posts/poster-136" target="_blank">view thread online</a></td><td align="right"><table border="0" cellspacing="0" cellpadding="0"><tbody><tr><td><a style="text-decoration:none;color:black" href="https://citizenspring.be/api/unfollow?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7Ik1lbWJlcklkIjo0MDZ9LCJpYXQiOjE1NTExODk0MjcsImV4cCI6MTU1MTc5NDIyNywic3ViIjoidW5mb2xsb3cifQ.NEVwoL9Ha26OaZ3PKuuqX4uXCcKAErwbS46VHTH-ycY" target="_blank">unfollow this thread</a></td></tr></tbody></table></td><td width="5"></td></tr></tbody></table></div></blockquote></div></div>\r\n</blockquote></div>\r\n',
    };
    const html = libemail.getHTML(email);
    expect(html).toEqual(
      `<p>Here is the poster made by Stien for everyone to see:<br><img src=https://d.pr/free/i/6XpCWL+>`,
    );
  });
  ...
  it('removes quoted email and email signature from gmail', () => {
    ...
    const res = libemail.getHTML({ 'body-html': html });
    expect(res).toEqual(
  ...
  it('removes quoted email and email signature from gmail', () => {
    const res = libemail.getHTML({
      'body-html':
        '<div><div dir="auto">Not yet :-/&nbsp;</div></div><div dir="auto">It’s on my todo list.</div><div dir="auto"><br></div><div dir="auto">In the meantime feel free to just send it to my email <a href="mailto:email@domain.org">email@domain.org</a></div><div><br><div class="gmail_quote"><div dir="ltr" class="gmail_attr">On Tue, Feb 26, 2019 at 2:57 PM Stien Verbelen &lt;<a href="mailto:design@citizenspring.be">design@citizenspring.be</a>&gt; wrote:<br></div><blockquote class="gmail_quote" style="margin:0 0 0 .8ex;border-left:1px #ccc solid;padding-left:1ex">\r\n    <u></u>\r\n    \r\n      \r\n        \r\n      \r\n      <div style="margin:0;padding:0">\r\n      \r\n      <table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td colspan="5" style="font-family:Helvetica Neue;line-height:1.3;padding:10px"><div><div>How do i do that? Can i upload it on the website? 🤔</div></div><table style="margin-top:2rem" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td colspan="6" style="color:#555;line-height:28px;font-size:14px"><span>Pick a quick reaction (or hit reply)</span></td></tr><tr><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%F0%9F%91%8D" style="font-size:28px;text-decoration:none;display:box;margin:13px" target="_blank">👍</a></td><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%F0%9F%91%8E" style="font-size:28px;text-decoration:none;display:box;margin:13px" target="_blank">👎</a></td><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%F0%9F%98%84" style="font-size:28px;text-decoration:none;display:box;margin:13px" target="_blank">😄</a></td><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%F0%9F%98%95" style="font-size:28px;text-decoration:none;display:box;margin:13px" target="_blank">😕</a></td><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%F0%9F%8E%89" style="font-size:28px;text-decoration:none;display:box;margin:13px" target="_blank">🎉</a></td><td><a href="mailto:design%2F136/221@citizenspring.be?subject=Re%3A%20Re%3A%20Poster&amp;body=%E2%9D%A4%EF%B8%8F" style="font-size:28px;text-decoration:none;display:box;margin:13px" target="_blank">❤️</a></td></tr></tbody></table></td></tr><tr><td colspan="5" height="30"> </td></tr><tr style="background:rgb(249,249,249);color:black;width:100%;font-family:Helvetica Neue;font-size:12px;margin-top:3rem;padding:3px;text-decoration:none;height:28px;line-height:28px"><td width="5"></td><td width="28" style="background-image:url(&#39;https://citizenspring.be/static/images/opencollectiveicon-48x48@2x.png&#39;);background-size:22px 22px;background-repeat:no-repeat;background-position:center center"></td><td align="left"><a style="text-decoration:none;color:black" href="https://citizenspring.be/design/posts/poster-136" target="_blank">view thread online</a></td><td align="right"><table border="0" cellspacing="0" cellpadding="0"><tbody><tr><td><a style="text-decoration:none;color:black" href="https://citizenspring.be/api/unfollow?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7Ik1lbWJlcklkIjo0MDZ9LCJpYXQiOjE1NTExODk0MjcsImV4cCI6MTU1MTc5NDIyNywic3ViIjoidW5mb2xsb3cifQ.NEVwoL9Ha26OaZ3PKuuqX4uXCcKAErwbS46VHTH-ycY" target="_blank">unfollow this thread</a></td></tr></tbody></table></td><td width="5"></td></tr></tbody></table></div></blockquote></div></div>\r\n',
    });
    expect(res).toEqual(
      `<p>Not yet :-/<br>It’s on my todo list.<p>In the meantime feel free to just send it to my email <a href=mailto:email@domain.org>email@domain.org</a>`,
    );
  });
